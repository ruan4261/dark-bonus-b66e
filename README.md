...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/dark-bonus-b66e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dark-bonus-b66e
```

A live public deployment of this template is available at [https://dark-bonus-b66e.templates.workers.dev](https://dark-bonus-b66e.templates.workers.dev)
